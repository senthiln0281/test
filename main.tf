...
resource "aws_lambda_permission" "apigw_lambda" {
  ...
  source_arn = "arn:aws:execute-api:${var.myregion}:${var.accountId}:${aws_api_gateway_rest_api.WildRydes.id}/*/${aws_api_gateway_method.POST.http_method}${aws_api_gateway_resource.ride.path}"
}
